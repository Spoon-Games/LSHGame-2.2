...
{
	[Serializable]
    [CreateAssetMenu(fileName = "Random Tile",menuName = "Tiles/Random Tile")]
...
//#endif
	...
	public class RandomTileEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			{
                string name = "Sprite " + (i + 1) + (tile.m_Sprites[i] != null ? tile.m_Sprites[i].name : "");
				tile.m_Sprites[i] = (Sprite) EditorGUILayout.ObjectField(name, tile.m_Sprites[i], typeof(Sprite), false, null);
			}		
